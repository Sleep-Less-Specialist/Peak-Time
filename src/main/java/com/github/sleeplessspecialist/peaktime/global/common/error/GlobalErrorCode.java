...
public enum GlobalErrorCode implements ErrorCode {
	...
	LOGIN_REQUIRED("G401", "LOGIN_REQUIRED", HttpStatus.UNAUTHORIZED),
	INVALID_AUTHENTICATION_TYPE("G500", "INVALID_PRINCIPAL_TYPE", HttpStatus.INTERNAL_SERVER_ERROR),
	ROLE_NOT_FOUND("G500", "ROLE_NOT_FOUND", HttpStatus.INTERNAL_SERVER_ERROR);
