...
public enum AuthErrorCode implements ErrorCode {
	...
	INVALID_CREDENTIALS("A401", "INVALID_CREDENTIALS", HttpStatus.UNAUTHORIZED),
	INVALID_REFRESH_TOKEN("A402", "INVALID_REFRESH_TOKEN", HttpStatus.UNAUTHORIZED),
	INVALID_PHONE_NUMBER("A403", "INVALID_PHONE_NUMBER", HttpStatus.BAD_REQUEST),
	REFRESH_REUSED("A404", "REFRESH_REUSED", HttpStatus.UNAUTHORIZED),
	EMAIL_ALREADY_EXISTS("A409", "EMAIL_ALREADY_EXISTS", HttpStatus.CONFLICT),
	PASSWORD_RESET_TOKEN_EXPIRED("A410", "PASSWORD_RESET_TOKEN_EXPIRED", HttpStatus.GONE),
	TOO_MANY_ATTEMPTS("A429", "TOO_MANY_ATTEMPTS", HttpStatus.TOO_MANY_REQUESTS);
